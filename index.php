    ...
    echo " active";
            ...
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole || 'salesman' == $sessionRole) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addDrug' == $id ) {
                    ...
                    <a href="index.php?id=addDrug"><i id="left" class="fas fa-user-plus"></i>Add Drug</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allDrug' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allDrug"><i id="left" class="fas fa-user"></i>All Drug</a>
            </li>
            <?php if ( 'customer' == $sessionRole ) {?>
                <li id="left" class="sideber__item "<?php if ( 'buyDrug' == $id ) {
                                                                            echo " active";
                                                                        }?>">
                    <a href="index.php?id=buyDrug"><i id="left" class="fas fa-shopping-cart"></i>Buy Drug</a>
                </li><?php }?>
        </ul>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
        ...
        <div class="container">
            ...
            <div class="customer">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                             <td>
                                                <center><img class="rounded-circle" width="40" height="40" src="assets/img/<?php echo $customer['avatar']; ?>" alt=""></center>
                                            </td>
                                            ...
                                            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole ) {?>
                                                <!-- For Admin, Manager, Pharmacist-->
                                                <td><?php printf( "<a href='index.php?action=editCustomer&id=%s'><i class='fas fa-edit'></i></a>", $customer['id'] )?></td>
                                                <td><?php printf( "<a class='delete' href='index.php?action=deleteCustomer&id=%s'><i class='fas fa-trash'></i></a>", $customer['id'] )?></td>
                                            <?php }?>
                                        </tr>
                ...
                <?php if ( 'deleteCustomer' == $action ) {
                        $customerID = $_REQUEST['id'];
                        $deleteCustomer = "DELETE FROM customers WHERE id ='{$customerID}'";
            ...
            <div class="drug">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            <td><?php printf( "%s", $drug['serialno'] );?></td>
                                            <td><?php printf( "%s", $drug['name'] );?></td>
                                            <td><?php printf( "%s", $drug['price'] );?></td>
                                            <td><?php printf( "%s", $drug['salesman'] );?></td>
                                            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole || 'salesman' == $sessionRole) {?>
                                                <!-- For Admin, Manager, Pharmacist-->
                                                <td><?php printf( "<a href='index.php?action=editDrug&id=%s'><i class='fas fa-edit'></i></a>", $drug['id'] )?></td>
                                                <td><?php printf( "<a class='delete' href='index.php?action=deleteDrug&id=%s'><i class='fas fa-trash'></i></a>", $drug['id'] )?></td>
                                            <?php }?>
                                        </tr>
                                ...
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            ...
                                            <input type="int" name="serialno" placeholder="Serial No." required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                    ...
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="text" name="salesman" placeholder="Salesman" required>
                                        </label>
                                    </div> 
                            ...
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-id-card"></i>
                                            <input type="int" name="serialno" placeholder="Serial No." value="<?php echo $drug['serialno']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-capsules"></i>
                                            <input type="text" name="name" placeholder="Name" value="<?php echo $drug['name']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-rupee-sign"></i>
                                            <input type="number" name="price" placeholder="Price" value="<?php echo $drug['price']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="text" name="salesman" placeholder="Salesman" value="<?php echo $drug['salesman']; ?>" required>
                                        </label>
                                    </div>
                ...
                <?php if ( 'buyDrug' == $id ) {?>
                    <div class="buyDrug">
                        <div class="main__form">
                            <div class="main__form--title text-center">Buy Drug</div>
                            <form action="buy.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-id-card"></i>
                                            <input type="int" name="serialno" placeholder="Serial No.">
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                    ...
                                    <input type="hidden" name="action" value="buyDrug">
                                    <?php if ( isset( $_REQUEST['error'] ) ) {
                                            echo "<h5 class='text-center' style='color:red;'>Serial No. or name Doesn't match Or Something is Wrong</h5>";
                                    }?>
                                    <div class="col col-12">
                ...
                <?php if ( 'makePayment' == $id ) {?>
                    <div class="makePayment">
                        <div class="main__form">
                            <div class="main__form--title text-center">Choose Payment Option</div>
                                <form>
                                    <div class="form-row">
                                        <div class="col col-12">
                                            <input type="submit" value="Net Banking">
                                        </div>
                                        <div class="col col-12">
                                        ...
                                        <div class="col col-12">
                                            <input type="submit" value="UPI Transfer">
                                        </div>
                                    </div>
                                </form>
                            </div>
